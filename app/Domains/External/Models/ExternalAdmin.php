<?php
namespace App\Domains\External\Models;
...
class ExternalAdmin extends Authenticatable implements MustVerifyEmail
{
    use HasApiTokens,
        HasFactory,
        HasRoles,
    ...
    protected $table = 'external_admins';
    protected string $guard_name = SettingEnum::TYPE_EXTERNAL_ADMIN;
